...
class StrategieTriangleEq10:
    ...
    def __init__(self, robot, distance, vitesse):
        ...
        self._vitesse=vitesse
        self._num_strat=0
        self._strategie=[StrategieAvanceAmeliore(robot, distance,vitesse), StrategieTournerDroiteAmeliore(robot, 120, 5)]
        self._i=0
...
class StrategiePolygone:
    ...
    def __init__(self, robot, vitesse, cotes):
        self._cotes=cotes
        self._robot=robot
        self._distance=30/self._cotes
        self._vitesse=vitesse
        self._num_strat=0
        self._strategie=[StrategieAvanceAmeliore(robot, self._distance,vitesse), StrategieTournerDroiteAmeliore(robot, 360/self._cotes, vitesse)]
        self._i=0
    ...
    def stop(self):
        return self._i>=self._cotes


class StrategieContour:
    ...
    def __init__(self, robot, distance, vitesse):
        ...
        self._vitesse=vitesse
        self._num_strat=0
        self._strategie=[StrategieFonce(robot, distance,vitesse), StrategieArcDroit(robot,30,5,90)]
        #self._strategie=[StrategieFonce(robot, distance,vitesse), StrategieTournerDroiteAmeliore(robot, 90, 5)]
        self._i=0
